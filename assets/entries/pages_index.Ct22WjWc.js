import {
  ...
  k as f,
  e as j,
} from "../chunks/chunk-DIGj699j.js";
/* empty css                      */ const y = ({ data: o }) => {
    const { system: t, resources: i, url: s } = o;
  ...
  S = ({ data: o }) => {
    const { pageMeta: t } = o,
      { origin: i } = new URL(o.url);
    let s = t.socialImageUrl;
    t.socialImageAssetName &&
      (s = `${i}${n({ src: `${r}/${t.socialImageAssetName}` })}`);
    const d = t.custom.some((a) => a.property === "twitter:card");
    return e.jsxs(e.Fragment, {
      children: [
        ...
        l,
        s && e.jsx("meta", { property: "og:image", content: t.socialImageUrl }),
        l,
        t.excludePageFromSearch &&
          e.jsx("meta", { name: "robots", content: "noindex, nofollow" }),
        t.custom.map(({ property: a, content: p }) =>
          e.jsx("meta", { property: a, content: p }, a)
        ),
        (t.socialImageAssetName !== void 0 || t.socialImageUrl !== void 0) &&
          d === !1 &&
          e.jsx("meta", {
            property: "twitter:card",
            content: "summary_large_image",
          }),
        e.jsx("link", { rel: "icon", href: n({ src: `${r}${f}` }) }),
        g.map((a) =>
          e.jsx(
            "link",
            {
        ...
        x.map((a) =>
          e.jsx("link", { rel: "preload", href: `${r}${a}`, as: "image" }, a)
        ),
      ],
    });
  },
  ...
  z = {
    ...
    Page: {
      ...
      valueSerialized: { type: "plus-file", exportValues: h },
    },
    Head: {
      type: "standard",
      definedAtData: {
      ...
      valueSerialized: { type: "plus-file", exportValues: v },
    },
  };
